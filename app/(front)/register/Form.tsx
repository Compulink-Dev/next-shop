    ...
    <div className="min-h-screen flex items-center justify-center bg-base-100 py-12 px-4">
      <div className="max-w-md w-full">
        ...
        <div className="text-center mb-8">
          ...
          <p className="text-base-content/60">Join Compulink IT Solutions today</p>
        </div>
        ...
        <div className="bg-base-200 rounded-2xl p-8 border border-base-300 shadow-xl">
          <form onSubmit={handleSubmit(formSubmit)} className="space-y-5">
            ...
            <div>
              ...
              {errors.name?.message && (
                <p className="text-error text-sm mt-1 ml-1">{errors.name.message}</p>
              )}
            </div>
            ...
            <div>
              ...
              {errors.email?.message && (
                <p className="text-error text-sm mt-1 ml-1">{errors.email.message}</p>
              )}
            </div>
            ...
            <div>
              ...
              {errors.password?.message && (
                <p className="text-error text-sm mt-1 ml-1">{errors.password.message}</p>
              )}
            </div>
            ...
            <div>
              ...
              {errors.confirmPassword?.message && (
                <p className="text-error text-sm mt-1 ml-1">{errors.confirmPassword.message}</p>
              )}
            </div>
